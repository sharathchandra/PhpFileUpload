createOrder.html: is the starting page where you enter order number in real time it would be randomly populated
finahtmlfordailog.php : this is the page where you will be having the various buttons
